...
const { Login, SignUp, Update, Delete, GetById, GetProfile, ForgotPassword, ResetPassword, VerifyEmail, UpdateNewsletter, UpdatePassword } = require("../controllers/user.controller"); // Importation de nos fonction du fichier controller
